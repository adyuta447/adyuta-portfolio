...
import socialLink from "@/app/data/sociallinks";
...
export function Navbar() {
  ...
  return (
    <header
      className={cn(
        "fixed top-2 left-2 right-2 mt-0 xl:mr-10 xl:ml-10 sm:mr2 rounded-3xl z-50 transition-all duration-500",
        isScrolled
    ...
    >
      <div className="mx-auto max-w-8xl px-4 sm:px-6 py-4">
        ...
        <div
          className={cn(
            "transition-all duration-400 md:hidden bg-background rounded-3xl overflow-hidden",
            isMobileMenuOpen
              ? "max-h-[500px] opacity-100 pt-4 pointer-events-auto"
